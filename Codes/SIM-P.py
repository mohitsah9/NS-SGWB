...
Ro=20
R0=Ro/(yrtosec*Gpctometer**(3)); sig=0.5; Mc1=28; alpha1=1.4; Mc2=30; alpha2=1.5; Mc3=32; alpha3=1.6; Mmax=Mc2*10+50
...
def Sample2(Nsample):
    def Pf2(m1):
        y1,_=integrate.quad(lambda m: PMF2(m),0.01,m1)
        return y1
...
g=open('3-'+str(Z1[0])+'-PBH'+str(obst)+'Samples='+str(npix)+'RP='+str(Ro)+'Mc='+str(Mc)+'alpha='+str(alpha)+'sigma='+str(sig)+'.txt','w')
